function resultcell = printResult(result,resultF,bit,method)
...
switch method
    ...
    case 'FAM'
        ...
        calFFT1n_n = 2^(-2*bit_fft1)/6+calFFT1_n*resultF.Scale.FirstFFT^2;
        calFFT1n_s = calFFT1_s*resultF.Scale.FirstFFT^2;
        ...
        calMultin_n = 2^(-2*bit_multi)/6+calMulti_n*resultF.Scale.Multi^2;
        calMultin_s = calMulti_s*resultF.Scale.Multi^2;
...
%         expN = 10*log10(PsignalN/PnoiseN);
        [~,~,expN] = TheoryFAM(Ps,q1,q2,q3,nFFT1,nFFT2,bits,bit_fft1,bit_multi,bit_fft2);
        ...
        resultcell = {bit.windowing,bit.firstFFT,bit.ConjMulti,bit.secondFFT,10*log10(avgFFT2n_s/avgFFT2n_n),expN,q1,q2,q3};
...
%         expN1 = 10*log10(PsignalN/PnoiseN);
        [~,~,expN] = TheorySSCA(Ps,q1,q2,q3,nFFT1,nFFT3,bits,bit_fft1,bit_multi,bit_fft2);
